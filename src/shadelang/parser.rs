...
impl<I: Iterator<Item = char>> Scanner<I> {
    ...
    pub fn scan_token(&mut self) -> ScanningResult {
        ...
        match c {
            '(' => Ok(ScanningProduct::Token(Token::LeftParen)),
            ')' => Ok(ScanningProduct::Token(Token::RightParen)),
            '{' => Ok(ScanningProduct::Token(Token::LeftBrace)),
            '}' => Ok(ScanningProduct::Token(Token::RightBrace)),
            '=' => Ok(ScanningProduct::Token(Token::Equals)),
