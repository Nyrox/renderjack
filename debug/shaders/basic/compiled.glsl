...
vec3 __impl_main() {
	...
	vec2 VecAddTest = Vec2Test + Vec2Test;
	vec3 VecSubTest = Vec3Test - Vec3Test;
	vec4 VecDivTest = Vec4Test / 2;
	vec4 VecMulTest = Vec4Test * 3;
	...
	float DotTest = dot(Vec3Test, Vec3Test);
